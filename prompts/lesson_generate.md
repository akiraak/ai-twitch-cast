...
`display_text` のコンテンツ量に応じてパネルの表示サイズを調整する。省略可（省略時はデフォルト設定を使用）。
...
| コンテンツ量 | maxHeight | fontSize |
|-------------|-----------|----------|
| 短い（1-2行、タイトルのみ） | 20-30 | 1.4-1.8 |
| 中程度（3-5行） | 35-50 | 1.2-1.4 |
| 長い（コードブロック、リスト等） | 55-70 | 1.0-1.2 |
