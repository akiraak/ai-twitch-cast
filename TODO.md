...
- [>] 録画の別アプローチ：画面キャプチャ＋WASAPI Loopback で AV 同期を OS 任せにする（Step 3 完了 / 実機検証は Step 4） → [plans/recording-screen-capture-alternative.md](plans/recording-screen-capture-alternative.md)
  - [ ] **Step 4**: 60秒〜30分長尺で AV 同期と CPU 負荷を計測（実機テスト含む）
