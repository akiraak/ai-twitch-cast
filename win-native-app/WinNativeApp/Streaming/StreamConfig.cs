...
public class StreamConfig
{
    ...
    /// デフォルト: -0.3（C+A: cap=30 での平均堆積 ~150ms ＋ プライム silence 300ms ＋
    /// 初期遅延の合計 ~500ms を中央値でオフセット補正。plans/recording-av-sync-fix.md C+A）
    /// </summary>
    public double AudioOffset { get; set; } = -0.3;
